...
print "];"
print """
scatter3(a(find(a(:,4)==1),1),a(find(a(:,4)==1),2),a(find(a(:,4)==1),3),'r','.'); 
hold on; 
scatter3(a(find(a(:,4)==2),1),a(find(a(:,4)==2),2),a(find(a(:,4)==2),3),'b','.'); 
hold on; 
scatter3(a(find(a(:,4)==3),1),a(find(a(:,4)==3),2),a(find(a(:,4)==3),3),'g','.');
hold on; 
scatter3(a(find(a(:,4)==4),1),a(find(a(:,4)==4),2),a(find(a(:,4)==4),3),'y','.');
"""
